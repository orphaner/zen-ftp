...
class UMySQL extends AbstractUDb {

   /**
    * Constructeur de la class
    * Initialise la connexion
    */
   function UMySQL($DBHost, $DBLogin, $DBPassword, $DBName) {
      $this->DB =& mysqlDB::getInstance($DBHost, $DBLogin, $DBPassword, $DBName);
   }

   /**
   * @return requete update format mySQL
   **/
   ...
   /**
   * @return requete update user format mySQL
   **/
   ...
   /**
   * @return requete delete user format mySQL
   **/
   ...
   /**
   * @return requete select user format mySQL
   **/
   ...
   /**
   * @return requete select all users format mySQL
   **/
   ...
   /**
   * @return requete update status format mySQL
   **/
